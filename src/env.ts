import type { EnvironmentKey, EnvironmentVariable, NodeEnv } from './types.js';
 ...
 */
export const getRequiredEnv = (envKey: EnvironmentKey): string =>
  required(getEnv(envKey), envKey as string);
