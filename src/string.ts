import { isNull, isString } from './guards.ts';
import { isWordOrWords } from './internals/string.ts';
import { hasInvalidCasing, tokenize } from './internals/tokenize.ts';
import type { Nullish, Sensitivity } from './types.ts';
